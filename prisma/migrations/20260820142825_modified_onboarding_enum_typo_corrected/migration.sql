/*
  ...
  - The values [BUSINESSS_PROFILE_COMPLETED] on the enum `OnboardingStep` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "OnboardingStep_new" AS ENUM ('PHONE_VALIDATED', 'PROFILE_COMPLETED', 'BUSINESS_PROFILE_COMPLETED', 'LIVENESS_PASSED', 'PIN_COMPLETED');
