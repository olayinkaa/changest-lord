...
export interface ILiveness {
	...
	getLivenessSessionResult(user: { id: string; phone: string }, sessionId: string): Promise<any>
	submitLivenessSessionCapture(user: { id: string; phone: string }, data: { image: string }): Promise<any>
}
